...
output "ec2_central_instance_id" {
  description = "id of the central server"
  value = module.ec2_central.ec2_central_instance_id
}

output "ec2_central_server_ip" {
  description = "ipv4 address of the central server"
...
module "ec2_jenkins_slave" {
  source = "./modules/ec2_jenkins_slave"
}

output "ec2_jenkins_slave_instance_id" {
  description = "id of the jenkins slave server"
  value = module.ec2_jenkins.ec2_jenkins_slave_instance_id
}

output "ec2_jenkins_slave_server_ip" {
  description = "ipv4 address of the jenkins slave server"
  value = module.ec2_jenkins.ec2_jenkins_slave_public_ip
}
